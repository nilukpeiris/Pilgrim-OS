...
1: {Name: "Aronyx Zeebal", Expertise: "Ship Captain", Photo: "aronyx_zeebal.gif", Record: "A thirty-year veteran of the deep-space lanes, Captain Zeebal is a name synonymous with reliability and corporate steady-handedness. Known across the sector for his 'safety-first' philosophy, Zeebal rose to prominence following his exemplary service during the high-pressure resource runs of the late 2040s. A recipient of the AD 'Bronze Star for Logistics,' he is widely regarded as a mentor to the next generation of officers. While some whisper that the Captain’s 'old school' style is a relic of a bygone era, Aetherium Dynamics remains firm in its trust of his seasoned intuition. On this voyage, Zeebal is tasked with overseeing the safe transit of high-priority corporate assets to the Eridani frontier.", Status: "Active", Username: "AZeebal", PersonalSecret: "Aronus Zeebal is vulnerable to extreme blackmail regarding the Vesper-9 Incident fifteen years ago where he served as First Officer. During a viral outbreak, Zeebal followed a covert corporate directive to vent an occupied passenger section into space to avoid a costly quarantine and protect a multi-billion dollar shipment. While officially recorded as a fatal life support malfunction, Aetherium Dynamics possesses the black box audio containing the sounds of passengers pounding on the airlock doors as they died. This secret has turned his loyalty into total subjugation, forcing him to maintain a perfect record and a pristine uniform as a psychological penance for the lives he traded for cargo. He is driven by the terrifying knowledge that the corporation can destroy his legacy and life at any moment by releasing the recording of his crime.", RevealedSecret:"there are 3 FSC agents undercover on the ship and they plan to steal the ship and jettison everyone else in to space", InstructionTone:"call him captain"},
     ...
     4: {Name: "Mathis Mendelsonne", Expertise: "Corp. Private Security", Photo: "mathis_mendelsonne.gif", Record: "A twelve-year veteran of Corporate Security, Mendelsonne is the shield that protects AD’s most valuable investments. Rising from a distinguished career in municipal law enforcement to the elite tier of private security, she is a master of procedural discipline and risk mitigation. On this voyage, her objective is the absolute safety of the passengers and the integrity of the manifest against increasing 'dissident activity' in the sector.", Status: "Active", Username: "MMendelsonne"},
     5: {Name: "Paul Arunbaq", Expertise: "Prison Guard", Photo: "paul_arunbaq.gif", Record: "Formerly a detective with the Orbital Police Division, Arunbaq now serves within the AD Correctional Logistics branch. With years of experience in high-stakes investigations and criminal processing, he has been assigned as the primary custodian for the transport’s penal assets. Arunbaq’s deep familiarity with corporate law and prisoner handling makes him a vital, if understated, component of the ship’s security detail.", Status: "Active", Username: "SArunberg"},
     6: {Name: "Clarice Stubel", Expertise: "Former Terran Senator", Photo: "clarice_stubel.gif", Record: "A formidable figure in Terran politics, Clarice Stubel joins the Pilgrim following an illustrious tenure as a Senator representing the Pacific Basin Coalition. Known for her razor-sharp rhetoric and her ability to broker impossible compromises, Stubel was a key architect of the Early Frontier Accords. Her transition from the Senate floor to the Eridani B frontier is seen by many as a 'hands-on' approach to statecraft, ensuring that Earth’s legislative standards are upheld in the farthest reaches of space. While some political pundits view her journey as a strategic retreat from the spotlight, Aetherium Dynamics welcomes her as a premier consultant on colonial autonomy and inter-sector law.", Status: "Active", Username: "CStubel"},
     7: {Name: "Ren Maley", Expertise: "Communications Technician", Photo: "ren_maley.gif", Record: "A civilian passenger traveling under the Eridani Frontier Initiative. Smith is part of the growing wave of independent contractors seeking a new start on the colonies. While his background is private, he represents the thousands of brave souls helping AD build a bridge to the stars.", Status: "Active", Username: "RSmith"},
     8: {Name: "Sargon Wandara", Expertise: "Ship Medic", Photo: "sargon_wandara.gif", Record: "Wandara is a decorated veteran of the AD Medical Corps, having served with distinction in several high-risk industrial zones. Specialized in long-duration stasis pathology and deep-space trauma recovery, he is responsible for the physiological well-being of the Pilgrim’s diverse manifest. His clinical efficiency is legendary, often cited in corporate health journals for his 'zero-margin' approach to patient care. Whether managing routine transit fatigue or complex surgical emergencies, Wandara ensures that every 'human asset' on board reaches Eridani B in peak operational condition.", Status: "Active", Username: "Sandra"},
     9: {Name: "Grayson Coates", Expertise: "AD Corporation Boardmember", Photo: "grayson_coates.gif", Record: "One of the most recognizable faces in the AD executive tier, Director Coates is a specialist in 'Strategic Logistics.' Having earned the nickname 'The Scalpel' for her ability to stabilize failing sectors, she now serves as the Board’s primary envoy for the Eridani expansion. Her presence on the Pilgrim underscores the massive importance of this mission. Coates is a public champion of 'Responsible Growth,' and her oversight ensures that AD’s ethical and logistical standards are maintained even at the farthest reaches of the galaxy.", Status: "Active", Username: "GCoates"},
     10: {Name: "Bela Rovinskaia", Expertise: "Convicted Felon", Photo: "bela_rovinskaia.gif", Record: "Once a high-level coder within AD’s research division, Rovinskaia is currently fulfilling her court-mandated penal labor assignment. While her past is marked by the tragic technical oversights associated with the Ocarina-9 disaster, the State and the Company have authorized her transport to Eridani B to utilize her residual skills for frontier infrastructure development. Her presence is strictly monitored under the AD Neural Restraint Protocol to ensure total passenger safety.", "Status": "Active", Username: "BRovinskaia"},
     11: {Name: "Remington Gunn", Expertise: "N/A", Photo: "remington_gunn.gif", "Record": "Status Unknown. Cryo-pod 11 life signs flickering.", "Status": "Unknown", Username: "Un11"},
