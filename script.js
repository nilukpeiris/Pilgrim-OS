...
const PLAYER_PROFILES = {
     ...
     8: {Name: "Ren Maley", Expertise: "Communications Technician", Photo: "ren_maley.gif", Record: "A civilian passenger traveling under the Eridani Frontier Initiative. Smith is part of the growing wave of independent contractors seeking a new start on the colonies. While his background is private, he represents the thousands of brave souls helping AD build a bridge to the stars.", Status: "Active", Username: "RMaley"},
     9: {Name: "Sargon Wandara", Expertise: "Ship Medic", Photo: "sargon_wandara.gif", Record: "Wandara is a decorated veteran of the AD Medical Corps, having served with distinction in several high-risk industrial zones. Specialized in long-duration stasis pathology and deep-space trauma recovery, he is responsible for the physiological well-being of the Pilgrim’s diverse manifest. His clinical efficiency is legendary, often cited in corporate health journals for his 'zero-margin' approach to patient care. Whether managing routine transit fatigue or complex surgical emergencies, Wandara ensures that every 'human asset' on board reaches Eridani B in peak operational condition.", Status: "Active", Username: "SWandara"},
     10: {Name: "Remington Gunn", Expertise: "N/A", Photo: "remington_gunn.gif", "Record": "Status Unknown. Cryo-pod 11 life signs flickering.", "Status": "RGunn", Username: "Un11"},
